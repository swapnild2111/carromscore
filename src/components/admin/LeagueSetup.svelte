...
<style>
  ...
  @media (prefers-color-scheme: light) {
    :root:not([data-theme="dark"]) .league-setup-card { background: #fff; border-color: rgba(0, 0, 0, 0.1); }
    ...
    :root:not([data-theme="dark"]) .league-setup-card { color: #111; }
  ...
  :root[data-theme="light"] .league-setup-card { background: #fff; border-color: rgba(0, 0, 0, 0.1); color: #111; }

...
**Organiser scope (v3.3):** organisers see and can Edit / Delete /
Merge only players they created themselves. Super sees every
player in the list with full row actions.
